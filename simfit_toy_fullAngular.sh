...
if make simfit_toy_fullAngular; then
	...
	./simfit_toy_fullAngular ${bin} ${gen1} ${gen2} ${gen3} ${gen4} ${gen5} ${gen6} ${gen7} ${gen8} ${f1} ${f4} ${b1} ${b4} ${m1} ${m4} ${seed} ${nsam} 0 ${save} 2016 2017 2018 \
	    &>logs_toyFit/simfit_toy2_fullAngular_${bin}_${gen1}_${gen2}_${gen3}_${gen4}_${gen5}_${gen6}_${gen7}_${gen8}_${f1}_${f4}_${b1}_${b4}_${m1}_${m4}_${seed}_${nsam}_2016_2017_2018.out &
