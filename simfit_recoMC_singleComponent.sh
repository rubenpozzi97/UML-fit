...
while [ ${tag} -ge 0 ]; do
	...
	./simfit_recoMC_singleComponent ${bin} ${par} ${tag} 1 1 ${datalike} ${year1} ${year2} ${year3}\
	    &> logs_simFit/simfit_recoMC_singleComponent_${bin}_${par}_${tag}_${year1}_${year2}_${year3}_dataStat${datalike}.out &
