...
Output      = logs_parSub/simfit_recoMC_fullAngular_RefTest_\$INT(nsamp)_\$INT(bin).out
Error       = logs_parSub/simfit_recoMC_fullAngular_RefTest_\$INT(nsamp)_\$INT(bin).err
