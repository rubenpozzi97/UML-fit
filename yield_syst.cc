...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  std::vector<std::string> col_name_stat = {"$q^2$ bin", "Year", "Nominal", "Exp($5.1<m<5.6$)", "Exp($5.0<m<5.5$)", "WT fixed/Exp+erf", "Scale factor", "No SigmaRT1"};
  for(int c = 0; c < 6; c++){
