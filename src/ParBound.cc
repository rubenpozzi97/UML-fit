...
//    ret0 = 0.5*(1-expo0/sqrt(1+expo0*expo0));
    ret0 = 0.5*erfc(expo0);
//    ret0 = exp(-200*pow(ctL4phi1/16.0,power2/2));
//    ret0 =  0.5*(1-tanh(expo0));
//    ret0 = exp(-200*pow(ctL4phi1,2));
...
// 	       <<" ret0= "<<ret0<<"expo0 = "<<expo0<< std::endl;
//       return 1e-300;
//     }
//  }
//
...
//       double min4 = TMath::Min(ctL1,TMath::Min(ctL5m,ctL5p));
       max4 = TMath::Max(ctL1,TMath::Max(ctL5m,ctL5p));
       double expo4 = coef4*(max4)+shift4;
//       double expo4 = coef4*(max4/fabs(max4)*fabs((b0+b1+b2)*(c0+c1+c2)*(a0+a1+a2+a3+a4)))+shift4;
//       double expo4 = -coef4*(max4)-shift4;
//      local_ret4 = 0.5*(1-tanh(expo4));
...
//       local_ret4 = 0.5*erfc(-expo4);
       local_ret4 = 1/(1+exp(-expo4));
...
//    if(max_ret4< local_ret4)  max_ret4= local_ret4;
      ret4=min_ret4;
...
//    ret=ret*local_ret4*local_ret5*local_ret6;
  ...
  ret=ret0;
//  ret=ret0*ret4;
//  if(ret>ret0)ret=ret0; 
//  if(ret>ret4)ret=ret4; 
  
   if(verbose){
    std::cout<<Form("Q2Bin=%d cond 0=%d 1=%d 2=%d 3=%d 4=%d ret0=%3.10f ret4=%3.10f  retTot=%3.10f ctL4phi1=%3.10f local_ret4=%3.10f \
    min_ret4=%3.10f max4=%3.10f",Q2Bin,cond0,cond1,cond2,cond3,cond4,
    ret0,ret4,ret,ctL4phi1,local_ret4,min_ret4,max4)<<std::endl;
   } 
  return ret ;
